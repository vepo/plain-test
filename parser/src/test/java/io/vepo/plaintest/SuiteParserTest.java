...
public class SuiteParserTest {
	...
	public void indexTest() {
		assertEquals(Suite.builder().index(0).name("T1")
				...
				.step(Step.builder().index(1).plugin("Process").name("Step2").attribute("cmd", "ls").build())
				.step(Step.builder().index(2).plugin("Process").name("Step3").attribute("cmd", "cd new-folder").build())
				.suite(Suite.builder().index(3).name("T2")
						.step(Step.builder().index(0).plugin("Process").name("Step2.1").attribute("cmd", "ls").build())
						.build())
				.step(Step.builder().index(4).plugin("Process").name("Step4").attribute("cmd", "ls *.txt").build())
